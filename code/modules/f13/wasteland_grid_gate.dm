...
/obj/machinery
	// Opt-in flag. Most machines should ignore grid gating unless explicitly enabled.
	var/requires_wasteland_grid = FALSE

/obj/machinery/proc/on_wasteland_grid_change()
